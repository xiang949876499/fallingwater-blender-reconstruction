...
TARGET=ROOT/'scene/Fallingwater_bridge10_endfix.blend'
Q=ROOT/'qa'
...
try:
    ...
    (Q/'bridge10-watertrim-endfix-fingerprint.json').write_text(json.dumps(compact,separators=(',',':')),encoding='utf8')
    ...
    (Q/'bridge10-watertrim-endfix-check.json').write_text(json.dumps(report,indent=2),encoding='utf8')
