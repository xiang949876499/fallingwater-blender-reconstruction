...
baseline=ROOT/'scene/Fallingwater_geology_baseline06_no_water.blend'
assert baseline.exists()  # Frame48 equivalence already verified; preserve original baseline.
before=snapshot()
...
cfg['core_bedrock_revision']='discontinuous_beds_v3'
...
candidate=ROOT/'scene/Fallingwater_geology_candidate07c.blend'
scene['bedrock_revision']='discontinuous_beds_v3 VISUAL_PENDING'
...
report={'status':'PASS_BOUNDED_GEOMETRY_VISUAL_NOT_RUN','frame':48,'reference_annotation':'qa/core-geology-07b-reference-annotations.png','material_audit':'qa/geology-baseline-material-inspect07c.json','source':str(source),'source_sha256':source_sha,
...
(ROOT/'qa/core-geology-candidate07c-check.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
