...
def build(ctx):
 ...
 for tn,rid,rr,lev,mat,probe in THRESHOLDS:
  physical_rr=physical_threshold_source_rect(tn,rr)
  zz=LEVELS[lev];ob=floor('MAIN_floor_threshold_'+tn,rect(*physical_rr),zz,.18,mat,rid=rid);ob['component_type']='floor';ob['threshold_id']=tn
  ob=prism('MAIN_floor_threshold_'+tn+'_finish',rect(*physical_rr),zz,zz+.022,mat,rid=rid);ob['component_type']='floor';ob['threshold_id']=tn
