...
assert old_bottom==[tuple(v.co) for v in core.data.vertices[25*53:26*53]],'Lower core perimeter changed'
...
candidate=ROOT/'scene/Fallingwater_geology_candidate07.blend'
scene['bedrock_revision']='discontinuous_beds_v1 VISUAL_PENDING'
...
report={'status':'PASS_BOUNDED_GEOMETRY_VISUAL_NOT_RUN','source':str(source),'source_sha256':source_sha,
...
(ROOT/'qa/core-geology-candidate07-check.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
