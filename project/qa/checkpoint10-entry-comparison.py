...
sources=[ROOT/'scene/Fallingwater_iteration10.blend',ROOT/'scene/Fallingwater_iteration10_rebuilt.blend']
out=ROOT/'qa/checkpoint10-entry-comparison.json';assert not out.exists()
def state(path):
