...
report = audit_dimensions(ROOT, scene_path=source, expected_sha256=digest,
                          prefix='dimensions-iteration07-finish-independent', write_csv=False)
...
(ROOT / 'qa/dimensions-iteration07-finish-verification.json').write_text(json.dumps(result, indent=2), encoding='utf-8')
