...
('MAIN_B_PLUNGE','Plunge Pool','B',[(535,380),(628,380),(628,352),(691,352),(697,380),(697,424),(535,424)],(601,401),(678,381),'pool'),
...
ADJACENCY = [
 ...
 ('MAIN_L1_LIVING','MAIN_L1_HATCH','hatch_stairs'),('MAIN_L1_LOGGIA','MAIN_B_PLUNGE','exterior_steps'),('MAIN_L1_LOGGIA','MAIN_L1_TERRACE_E','exterior_steps'),
...
def room_records():
 ...
 for rid,label,lev,p,c,e,kind in ROOM_SPECS:
  ...
  if kind in ('foundation','pool'): z=-2.8467
...
def build(ctx):
 ...
 chain('MAIN_B_pool_wall',[(533,376),(700,376),(700,431),(533,431)],-2.5,-1.97,.28,'stone')
