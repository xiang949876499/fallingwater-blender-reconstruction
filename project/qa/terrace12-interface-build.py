...
OUT=ROOT/'scene/Fallingwater_terrace_interface_candidate12a.blend'
...
import main_terrace12
spec=json.loads(bpy.data.texts['FW_ITERATION11_DETAILS.json'].as_string())['terraces']
result=main_terrace12.apply(spec)
...
(ROOT/'qa/terrace12-interface-build.json').write_text(json.dumps(result,indent=2),encoding='utf8')
